...
save.image(file='GaussClust.workspace.RData')
...
echo "INFO      | $(date) | Done conducting clustering and classification using Gaussian mixture models (GMMs), and related analyses, "
echo "INFO      | $(date) | using GaussClust. "
echo "INFO      | $(date) | Bye.
"
#
#
